      ...
      <div className="max-w-8xl container mx-auto py-16">
        ...
        <section className="text-center mb-20">
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            Have a project in mind or want to learn more about our services? Reach out to us and let's start a conversation.
          </p>
        </section>
            ...
            <div className="space-y-8">
              ...
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <p className="text-gray-400">123 Creative Street<br />Karchi , Sindh Pakistan</p>
                </div>
              </div>
            </div>
